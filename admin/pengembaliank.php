...
<h3><span class="glyphicon glyphicon-briefcase"></span>  Data Pengembalian Komponen</h3><br>
...
<table class="table">
	...
	<?php 
		...
		$brg=mysqli_query($conn,"SELECT * FROM peminjamank WHERE jumlah > jumlah_kembali OR jumlah_kembali < jumlah ORDER BY id DESC");
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<div class="modal-body">				
					<form action="pengembaliank_act.php" method="post">
						<div class="form-group">
							<label>Nama Peminjam</label>								
							<select class="form-control" name="nama_peminjam" id="nuser">
								<?php 
								$brg=mysqli_query($conn,"select * from peminjamank where jumlah > jumlah_kembali or jumlah_kembali < jumlah");
								while($b=mysqli_fetch_assoc($brg)){
									?>	
						...
						<div class="form-group">
							...
							<select class="form-control" name="nama_barang">
								<?php 
								$brg=mysqli_query($conn,"select distinct(nama_barang) from  peminjamank where jumlah > jumlah_kembali or jumlah_kembali < jumlah");
								while($b=mysqli_fetch_assoc($brg)){
									?>	
