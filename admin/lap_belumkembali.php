...
$pdf->Cell(25.5,0.7,"LAPORAN DATA PEMINJAMAN ALAT",0,10,'C');
$pdf->Cell(25.5,0.7,"TEKNIK ELEKTRONIKA INDUSTRI",0,10,'C');
$pdf->Cell(25.5,0.7,"SMKN 1 KEPANJEN",0,10,'C');

$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
$pdf->Cell(6,0.7,"dicetak pada tanggal : ".date("d M Y"),0,1,'C');
$pdf->Cell(7.5,0.7,"Data siswa yang belum mengembalikan alat",0,0,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
...
$pdf->Cell(4, 0.8, 'Nama Alat', 1, 0, 'C');
...
$query=mysqli_query($conn,"select * from peminjaman where jumlah > jumlah_kembali or jumlah_kembali < jumlah");
