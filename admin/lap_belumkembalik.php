...
$pdf->Cell(8,0.7,"Data siswa yang belum mengembalikan Komponen",0,0,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
...
$query=mysqli_query($conn,"select * from peminjamank where jumlah > jumlah_kembali or jumlah_kembali < jumlah");
